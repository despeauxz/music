				...
				<div class="jp-interface">
					<div class="jp-controls">
						...
						<div>
							...
							<a class="jp-pause hid" style="display: none;">
						...
						<div class="hidden-xs hidden-sm jp-current-time text-xs text-muted">00:00</div>
							<div class="hidden-xs hidden-sm jp-duration text-xs text-muted">03:29</div>
								<div class="hidden-xs hidden-sm">
									<a class="jp-mute" title="mute">
										<i class="icon-volume-2"></i>
									</a>
									<a class="jp-unmute hid" title="unmute" style="display: none;">
								...
								<div>
									...
									<a class="jp-shuffle-off hid" title="shuffle off" style="display: none;">
								...
								<div>
									...
									<a class="jp-repeat-off hid" title="repeat off" style="display: none;">
								...
								<div class="hide">
									...
									<a class="jp-restore-screen" title="restore screen" style="display: none;">
					...
					<div class="jp-playlist dropup" id="playlist">
						<ul class="dropdown-menu aside-xl dker" style="display: block;">
							<li class="jp-playlist-current">
								<div>
									<a href="javascript:;" class="jp-playlist-item-remove">×</a><a href="javascript:;" class="jp-playlist-item jp-playlist-current" tabindex="1">Bubble
										<span class="jp-artist">by Miaow</span>
									</a>
								</div>
							</li>
							<li>
								<div>
									<a href="javascript:;" class="jp-playlist-item-remove">×</a><a href="javascript:;" class="jp-playlist-item" tabindex="1">Lentement
										<span class="jp-artist">by Miaow</span>
									</a>
								</div>
							</li>
							<li>
								<div>
									<a href="javascript:;" class="jp-playlist-item-remove">×</a><a href="javascript:;" class="jp-playlist-item" tabindex="1">Partir
										<span class="jp-artist">by Miaow</span>
									</a>
								</div>
							</li>
